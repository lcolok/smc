	...
	<div class="whole">
		<div class="player">
			<div class="player-controls">
				...
				<!-- </div> -->
				<div>
					<div class="button" @click.prevent="download" href="#">
						<svg
							width="18px"
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 20 20"
				...
				<div>
					<div class="button" @click.prevent="innerLoop = !innerLoop" href="#">
						<svg
							width="18px"
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 20 20"
				...
				<div>
					...
					>
						<template v-slot:activator="{ on }">
							<div class="button" v-on="on" :title="$t('Volume')" href="#">
								<svg
									width="18px"
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 20 20"
...
@import url('https://fonts.loli.net/css?family=Nunito:400,700');
